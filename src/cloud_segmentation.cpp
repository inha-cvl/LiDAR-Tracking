...
int main(int argc, char**argv) {
    ...
    pub_projection_cloud  = pnh.advertise<sensor_msgs::PointCloud2>("projectioncloud", 10, true);
    pub_projection_image = nh.advertise<sensor_msgs::Image>("projectedimage", 10, true);
    pub_crop_cloud  = pnh.advertise<sensor_msgs::PointCloud2>("cropcloud", 10, true);
    pub_ground      = pnh.advertise<sensor_msgs::PointCloud2>("ground", 10, true);
    pub_non_ground  = pnh.advertise<sensor_msgs::PointCloud2>("nonground", 10, true);
    pub_undistortion_cloud = pnh.advertise<sensor_msgs::PointCloud2>("undistortioncloud", 10, true);
    pub_downsampling_cloud  = pnh.advertise<sensor_msgs::PointCloud2>("downsampledcloud", 10, true);
    pub_cluster_array  = pnh.advertise<sensor_msgs::PointCloud2>("cluster_array", 10, true);
    pub_cluster_box = pnh.advertise<jsk_recognition_msgs::BoundingBoxArray>("cluster_box", 10, true);
